...
public class CancelOrderFrame extends javax.swing.JFrame {
    ...
    public CancelOrderFrame() {
        ...
        loadOrderedProductDetails(UserCredentials.getUserId());
    }
    ...
    private void jtOrderedTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jtOrderedTableMouseClicked
        ...
        System.out.println(model.getDataVector().get(jtOrderedTable.getSelectedRow()));
        System.out.println(jtOrderedTable.getSelectedRow());
        ...
        try {
            ...
            orderList.get(index).setCustomerName(UserCredentials.getUserName());
            Gmail gmail = new Gmail();
            gmail.setupServerProperties();
            gmail.sendCancelOrderOTPTo(orderList.get(index), otp, UserCredentials.getEmailId());
            String companyEmail = orderList.get(index).getCompanyEmailId();
