...
import org.foodie.utility.FoodApi;
import org.foodie.utility.SpoonacularFoodApi;
...
public class AddFoodFrame extends javax.swing.JFrame {
    ...
    private final FoodApi spoonacularApi = new SpoonacularFoodApi();
    ...
    private void btnSearchFoodActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchFoodActionPerformed
        ...
        if (txtSearchFood.getText().trim().isEmpty()) {
            JOptionPane.showMessageDialog(this, "Please Give The Food Name To Be Searched.", "Error", JOptionPane.ERROR_MESSAGE);
            return;
        }
        String searchFood = txtSearchFood.getText().trim().replace(' ', '-');
        System.out.println("food to be search " + searchFood);
        if (productList != null) {
            productList.clear();
        }
        try {
            productList = spoonacularApi.getFoodItemList(searchFood);
        } catch (Exception ex) {
            JOptionPane.showMessageDialog(this, "Couldn't Load This Product.", "Error", JOptionPane.ERROR_MESSAGE);
            return;
        }
        
        //It is adding data in the panel : 
    ...
    private void btnAddItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddItemActionPerformed
        ...
        try {
            ...
            product.setProductName(txtFoodName.getText().toUpperCase());
            product.setProductPrice(price);
            boolean isProductAdded = ProductDao.addProduct(product);
            System.out.println("product added : " + isProductAdded);
            if (!isProductAdded) {
                JOptionPane.showMessageDialog(this, "Can't Add The Product Now.\nTry Again Later", "Error", JOptionPane.ERROR_MESSAGE);
                return;
            }
            JOptionPane.showMessageDialog(this, "Product Added Successfully", "Success", JOptionPane.INFORMATION_MESSAGE);
            productList.remove(viewImageIndex);

            if (viewImageIndex >= productList.size()) {
                viewImageIndex = 0;
            }
            showFoodDetailsOfIndex(viewImageIndex);
    ...
    private void lblBackMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblBackMouseClicked
        ...
        if (viewImageIndex < 0) {
            viewImageIndex = productList.size() - 1;
        }

        System.out.println("mouse clicked left ..... ====" + viewImageIndex);
        showFoodDetailsOfIndex(viewImageIndex);
    ...
    private void lblNextMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblNextMouseClicked
        ...
        System.out.println("mouse clicked right ......... ====" + viewImageIndex);
        showFoodDetailsOfIndex(viewImageIndex);
    ...
    private void showFoodDetailsOfIndex(int viewImageIndex) {
        product = productList.get(viewImageIndex);
    ...
    private boolean validateInput() {
        if (txtFoodName.getText().trim().equals("") || txtFoodPrice.getText().trim().equals("") || lblFoodImage.getIcon() == null) {
            return true;
        }
        return false;
    }
