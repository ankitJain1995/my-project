...
public class CustomerRegisterFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/org/foodie/icon/login.png"))); // NOI18N
    ...
    private void btnRegisterCustomerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegisterCustomerActionPerformed
        ...
        customer.setEmailId(txtEmail.getText().trim().toUpperCase());
        ...
        try {
            ...
            System.out.println("is customer added " + isCustomerAdded);
            if (!isCustomerAdded) {
                JOptionPane.showMessageDialog(null, "Can't Register The Customer!\nPlease Try Again Later", "Error", JOptionPane.ERROR_MESSAGE);
                return;
            }
    ...
    private boolean validateInput() {
        if (txtEmail.getText().trim().equals("") || txtAddress.getText().trim().equals("") || txtName.getText().trim().equals("") || txtMobileNo.getText().trim().equals("") || String.valueOf(txtPassword.getPassword()).trim().equals("")) {
        ...
        if (!Validator.isValidEmail(txtEmail.getText().trim())) {
            JOptionPane.showMessageDialog(null, "please input valid Email Id!", "Error", JOptionPane.ERROR_MESSAGE);
            return true;
        }
