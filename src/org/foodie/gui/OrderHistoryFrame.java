...
public class OrderHistoryFrame extends javax.swing.JFrame {
    ...
    private Map<String, String> orderReviewMap;
    ...
    public OrderHistoryFrame() {
        ...
        loadDeliveredProductsDetails(UserCredentials.getUserId());
        reviewCount = 0;
        orderReviewMap = new HashMap<>();
    }
    ...
    private void btnPostReviewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPostReviewActionPerformed
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Review Posted Successfully.", "Success", JOptionPane.INFORMATION_MESSAGE);
            orderReviewMap.clear();
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    private void jtDeliveredProductTablePropertyChange(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_jtDeliveredProductTablePropertyChange
        ...
        try {
            ...
            System.out.println(model.getDataVector().get(jtDeliveredProductTable.getSelectedRow()));
            int index = jtDeliveredProductTable.getSelectedRow();
            String review = (String) model.getValueAt(index, 6);
            String orderId = (String) model.getValueAt(index, 0);

            review = review.trim();
            if (review.isEmpty() || orderId.isEmpty()) {
                return;
            }
            orderReviewMap.put(orderId, review.toUpperCase());

            btnPostReview.setText("Post Review (" + orderReviewMap.size() + ")");
