...
public class SellerOptionFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/org/foodie/icon/seller option.png"))); // NOI18N
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        // TODO add your handling code here:
        System.out.println("going to delete this company");
        int confirmDialog = JOptionPane.showConfirmDialog(null, "All the data and history will be deleted.\nDo you really want to UNREGISTER this company.", "Information",JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
        if (confirmDialog == JOptionPane.YES_OPTION) {
            try {
                showFrame=new SellerLoginFrame();
                showFrame.setVisible(true);
                this.dispose();
                System.out.println("deleted : " + CompanyDao.removeCompanyBy(OwnerProfile.getCompanyId()));
            } catch (SQLException ex) {
                ex.printStackTrace();
                JOptionPane.showMessageDialog(null, "Can't UNREGISTER this company!\nTry Again Later.", "Error", JOptionPane.ERROR_MESSAGE);
            }
        }
