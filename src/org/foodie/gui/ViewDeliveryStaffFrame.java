...
public class ViewDeliveryStaffFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(930, 554));
        setResizable(false);
        ...
        jPanel2.add(txtMobileNo, new org.netbeans.lib.awtextra.AbsoluteConstraints(211, 267, 250, 35));
        ...
        jPanel2.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(22, 267, 149, 35));
        ...
        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/org/foodie/icon/user.png"))); // NOI18N
    ...
    private void jcStaffIdsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jcStaffIdsActionPerformed
        ...
        System.out.println("select Item"+jcStaffIds.getSelectedItem().toString());

        String staffId = jcStaffIds.getSelectedItem().toString();

        try {
            StaffPojo staff = StaffDao.getStaffById(staffId);

            txtCompanyName.setText(OwnerProfile.getCompanyName());
            txtEmailId.setText(staff.getEmailId());
            txtName.setText(staff.getStaffName());
            txtMobileNo.setText(staff.getMobileNo());
    ...
    private void loadStaffIds() {
        try {
            staffIds = StaffDao.getStaffIds(OwnerProfile.getCompanyId());
            System.out.println("staff ids are "+staffIds);
            for (String staffId : staffIds) {
                jcStaffIds.addItem(staffId);
            }
        } catch (SQLException ex) {
            ex.printStackTrace();
