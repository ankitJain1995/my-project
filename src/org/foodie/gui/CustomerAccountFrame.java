...
import org.foodie.dao.CustomerDao;
...
public class CustomerAccountFrame extends javax.swing.JFrame {
    ...
    public CustomerAccountFrame() {
        ...
        loadCustomerDetailsByCustomerId(UserCredentials.getUserId());
    }
    ...
    private void initComponents() {
        ...
        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/org/foodie/icon/user.png"))); // NOI18N
    ...
    private void btnUpdateCustomerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateCustomerActionPerformed
        ...
        customer.setCustomerId(UserCredentials.getUserId());
        customer.setEmailId(txtEmail.getText().trim());
        customer.setCustomerName(txtName.getText().trim().toUpperCase());
        customer.setMobileNo(txtMobileNo.getText().trim());
        customer.setPassword(PasswordEncryption.getEncryptedPassword(String.valueOf(txtPassword.getPassword()).trim()));
        customer.setAddress(txtAddress.getText().trim().toUpperCase());
    ...
    private boolean validateInput() {
        if (txtAddress.getText().trim().equals("") || txtName.getText().trim().equals("") || txtMobileNo.getText().trim().equals("") || String.valueOf(txtPassword.getPassword()).trim().equals("")) {
    ...
    private void loadCustomerDetailsByCustomerId(String customerId) {
        try {
            customer = CustomerDao.getCustomerDetailsByCustomerId(customerId);
            txtEmail.setText(customer.getEmailId());
            txtName.setText(customer.getCustomerName());
            txtMobileNo.setText(customer.getMobileNo());
            txtPassword.setText(PasswordEncryption.getDecryptedPassword(customer.getPassword()));
