...
public class ViewOrderHistoryFrame extends javax.swing.JFrame {
    ...
    public ViewOrderHistoryFrame() {
        ...
        loadDeliveredOrderDetails(UserCredentials.getUserId());
    }
    ...
    private void loadDeliveredOrderDetails(String staffId) {
        try {
            ...
            for (OrderPojo order : orderList) {
                ...
                rows[3] = order.getCustomerAddress();
                rows[4] = order.getReview();
                model.addRow(rows);
            }
            System.out.println("order history of the staff should be loaded");
